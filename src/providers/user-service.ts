...
export class UserServiceProvider {
    ...
    public userRegisterUrl : string = MainServiceProvider.baseUrl+"/register/"+MainServiceProvider.lang;
    public userLoginUrl : string = MainServiceProvider.baseUrl+"/login/"+MainServiceProvider.lang;
    public userUpdateUrl : string = MainServiceProvider.baseUrl+"/updateuser/";
    public userForgetUrl :string = MainServiceProvider.baseUrl+"/forgetpassword/"+MainServiceProvider.lang;
    public getAreaUrl :string = MainServiceProvider.baseUrl+"/getarea?lang="+MainServiceProvider.lang;
    public getMucicpalityUrl :string = MainServiceProvider.baseUrl+"/getmuncpality/2?lang="+MainServiceProvider.lang;
    public getNotesUrl :string = MainServiceProvider.baseUrl+"/getnoticetype?lang="+MainServiceProvider.lang;
    public insertNewReportUrl :string = MainServiceProvider.baseUrl+"/insertnewreport/"+MainServiceProvider.lang;
    public showMyReportsUrl :string = MainServiceProvider.baseUrl+"/getmyreports/1?lang="+MainServiceProvider.lang;
    ...
    public searchBalaghUrl: string = MainServiceProvider.baseUrl+"/searchinreports?lang="+MainServiceProvider.lang;
    ...
    public aboutusUrl : string = MainServiceProvider.baseUrl+"/aboutus?lang="+MainServiceProvider.lang;
  ...
  userRegister(user:any)
  {
    ...
    return this.http.post(this.userRegisterUrl,user).map((res) => res.json());
  }
 
  userLogin(user:any)
  {
    user.lang = MainServiceProvider.lang;
    return this.http.post(this.userLoginUrl,user).map((res) => res.json());
  }
  ...
  userForgetPassword(email) {
    return this.http.post(this.userForgetUrl + MainServiceProvider.lang , JSON.stringify({'email': email}), this.postOptions)
      .map(res => res.json());
  }
  ...
  getMucicpality(){
   ...
   insertReport(report: any){
      report.lang = MainServiceProvider.lang;
      return this.http.post(this.insertNewReportUrl,report).map((res) => res.json());
   }
  ...
  getimportantnums(){
    return this.http.get(this.importantNumsUrl+MainServiceProvider.lang).map((res) => res.json());
   }
